          ...
          <div class="navbar-collapse-header d-md-none">
            <div class="row">
              <div class="col-6 collapse-brand">
                <a href="../index.html">
                  <img src="{{ asset('/') }}img/brand/semarang.png"  width="100px">
                </a>
              </div>
            ...
            <div class="card-header bg-transparent pb-5">
              <div class="btn-wrapper text-center">
                <a href="#" class="btn btn-danger btn-icon">
                  <span class="btn-inner--icon"><img src="{{ asset('/') }}img/icons/person.png"></span>
                  <span class="btn-inner--text">Login</span>
                </a>
                <a href="{{ url('register') }}" class="btn btn-danger btn-icon">
                  <span class="btn-inner--icon"><img src="{{ asset('/') }}img/icons/person.png"></span>
              ...
              @csrf
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    @error('username')
                        is-invalid
                    @enderror" placeholder="Masukkan Username" type="username" name="username"
                     value="{{ old('username') }}">
                  </div>
                </div>
                @error('username')
                ...
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    @error('password')
                    is-invalid
                    @enderror" placeholder="Masukkan Password" type="password" name="password">
                  </div>
                </div>
                @error('password')
                <div class="invalid-feedback">
